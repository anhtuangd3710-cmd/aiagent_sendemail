...
class YouTubeAnalyzer:
    ...
    ACTUAL_RPM = {
        ...
        'thailand': {'low': 0.40, 'avg': 0.75, 'high': 1.20},
        'brazil': {'low': 0.50, 'avg': 0.90, 'high': 1.50},
        'japan': {'low': 1.50, 'avg': 2.50, 'high': 4.00},
        'germany': {'low': 2.00, 'avg': 3.50, 'high': 5.50},
        'uk': {'low': 2.50, 'avg': 4.00, 'high': 6.50},
        'us': {'low': 3.00, 'avg': 5.00, 'high': 8.00},
        'canada': {'low': 2.50, 'avg': 4.00, 'high': 6.50},
        'australia': {'low': 2.50, 'avg': 4.00, 'high': 6.50},
        'international': {'low': 0.60, 'avg': 1.00, 'high': 1.60},
    }
...
{{
    ...
    def calculate_rpm(self, niche: str, region: str, engagement_rate: float = 0.05, 
        ...
        # Niche multiplier - tắt hết, RPM đã đủ thực tế
        niche_multipliers = {
            'finance': 1.0,
            'business': 1.0,
            'tech': 1.0,
        ...
        # Video length bonus - tắt, RPM đã bao gồm
